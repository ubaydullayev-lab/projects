            ...
            <div style={{ flex: 1, minWidth: '300px', background: '#222', padding: '30px', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.4)' }}>
              <Form layout="vertical" onFinish={onFinish} form={form}>
                <Form.Item name="name" rules={[{ required: true, message: 'Ismingizni kiriting!' }]}
                  label={<span style={{ color: '#00f5ff' }}>Ismingiz</span>}>
                  <Input placeholder="Ismingiz" size="large" />
                </Form.Item>

                <Form.Item name="email" rules={[{ required: true, type: 'email', message: 'Emailni kiriting!' }]}
                  label={<span style={{ color: '#00f5ff' }}>Email</span>}>
                  <Input placeholder="Email manzilingiz" size="large" />
                </Form.Item>

                <Form.Item name="message" rules={[{ required: true, message: 'Xabaringizni yozing!' }]}
                  label={<span style={{ color: '#00f5ff' }}>Xabar</span>}>
